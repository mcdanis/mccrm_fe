...
const ReportDashboard = () => {
    ...
    return (<>
        ...
        <div className="p-6 bg-gray-100 min-h-screen">
            <h1 className="text-2xl font-bold mb-6 text-gray-700">Laporan Sistem CRM</h1>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                {/* Ongoing Projects */}
                <div className="bg-white p-4 rounded-lg shadow">
                    <h2 className="text-xl font-semibold mb-4 text-gray-700">Projek Ongoing</h2>
                    {ongoingProjects.map((project, index) => {
                        const endDate = new Date(project.endDate);
                        const today = new Date();
                        const remainingDays = Math.ceil((endDate - today) / (1000 * 60 * 60 * 24));
                        return (
                            <div key={index} className="text-gray-600 mb-4 p-2 border rounded">

                                <h3 className="font-bold text-lg">{project.name}</h3>
                                <small className='text-gray-400'>Kampanye <span className='text-red-500'>/</span> sub kapanye</small>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                {/* Contacts Today */}
                <div className="bg-white p-4 rounded-lg shadow">
                    <h2 className="text-xl font-semibold mb-4 text-gray-700">Kontak Hari Ini</h2>
                ...
                <div className="bg-white p-4 rounded-lg shadow">
                    <h2 className="text-xl font-semibold mb-4 text-gray-700">Projek Closing Bulan Ini</h2>
            ...
            {/* Customers Per User */}
            <div className="bg-white p-4 rounded-lg shadow">
                <h2 className="text-xl font-semibold mb-4 text-gray-700">Jumlah Customer per User</h2>
                <ul>
